    ...
    <div class="container-fluid">
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
                ...
                <a href="{{ route('voucher.create') }}" class="btn btn-success btn-sm float-right" data-toggle="tooltip"
                    data-placement="bottom" title="Tạo Mã Giảm Giá"><i class="fas fa-plus"></i> Tạo Mới</a>
            </div>
            <div class="card-body">
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="{{ route('voucher.destroy', [$voucher->id]) }}">
                                                ...
                                                <button class="btn btn-danger btn-sm btn-action btnDelete"
                                                    data-id="{{ $voucher->id }}" data-toggle="tooltip"
