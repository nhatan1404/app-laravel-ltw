                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $count_posts }}
                                </div>
                            </div>
                            <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-primary shadow h-100 py-2">
                  <div class="card-body">
                      <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                              <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Danh Mục Bài Viết</div>
                              <div class="h5 mb-0 font-weight-bold text-gray-800">
                                  {{ $count_post_category }}</div>
                          </div>
                          <div class="col-auto">
                              <i class="fas fa-equal fa-2x text-gray-300"></i>
                          </div>
                      </div>
                  </div>
              </div>
